...
/**
 * This X509TrustManager implementation allows invalid certificates to possibly be accepted by the
 * decision of an {@link InvalidCertificateStrategy} that is passed as a constructor argument.
 * Certificates added in this way will be added via a {@link ExtraCertManager}, causing the
 * underlying trust manager to be reloaded.
 *
 * <p>Adapted from the implementation at <a href=
 * "https://jcalcote.wordpress.com/2010/06/22/managing-a-dynamic-java-trust-store/" >"Managing a
 * Dynamic Java Trust Store"</a> (blog post)
 */
